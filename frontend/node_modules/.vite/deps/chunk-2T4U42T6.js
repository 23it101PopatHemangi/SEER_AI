...
var require_browser_ponyfill = __commonJS({
  "node_modules/cross-fetch/dist/browser-ponyfill.js"(exports, module) {
    ...
    var ctx2 = __global__.fetch ? __global__ : __globalThis__;
    exports = ctx2.fetch;
...
__export(constants_exports, {
  ...
  IOS_MAX_RETRY_COUNT: () => IOS_MAX_RETRY_COUNT,
...
function isIOS() {
  return isBrowser() && typeof navigator !== "undefined" && typeof navigator.userAgent !== "undefined" && (/iPad|iPhone|iPod/.test(navigator.userAgent) && !window.MSStream);
}

// node_modules/@okta/okta-auth-js/esm/browser/http/request.js
var dateDocumentBecameVisible = 0;
var trackDateDocumentBecameVisible;
if (isBrowser()) {
...
function httpRequest(sdk, options) {
  ...
  if (pollingIntent && isBrowser() && pollDelay > 0) {
    ...
    const retryableFetch = () => {
      return sdk.options.httpRequestClient(method, url, ajaxOptions).catch((err2) => {
        const isNetworkError = (err2 === null || err2 === void 0 ? void 0 : err2.message) === "Load failed";
...
var WebauthnEnrollment = class extends Authenticator {
  ...
  mapCredentials(values) {
    ...
    return credentials || Object.assign({
      clientData,
      attestation
...
async function poll(authClient, options = {}) {
  var _a;
  const { withCredentials, exchangeCodeForTokens: exchangeCodeForTokens2 } = options;
...
var OktaUserAgent = class {
  constructor() {
    this.environments = [`okta-auth-js/${"7.14.5"}`];
...
var coerceTransports = (value) => {
  ...
  return Array.isArray(candidate) ? candidate : void 0;
};
var getEnrolledCredentials = (authenticatorEnrollments = []) => {
  ...
  authenticatorEnrollments.forEach((enrollement) => {
    ...
    if (enrollement.key === "webauthn") {
      ...
      const transports = (_a = coerceTransports(enrollement.transports)) !== null && _a !== void 0 ? _a : coerceTransports((_b = enrollement.profile) === null || _b === void 0 ? void 0 : _b.transports);
      if (transports) {
...
@okta/okta-auth-js/esm/browser/exports/exports/default.js:
   ...
   *)
*/
//# sourceMappingURL=chunk-2T4U42T6.js.map
